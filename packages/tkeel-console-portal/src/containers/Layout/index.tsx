...
// import CollapsedMenus from '@/tkeel-console-portal/containers/Layout/CollapsedMenus';
import Header from '@/tkeel-console-portal/containers/Layout/Header';
import Menus from '@/tkeel-console-portal/containers/Layout/Menus';
import useMenusQuery from '@/tkeel-console-portal/hooks/queries/useMenusQuery';
import NotFound from '@/tkeel-console-portal/pages/NotFound';
import {
  init as initQiankun,
  menusToApps,
} from '@/tkeel-console-portal/utils/qiankun';
